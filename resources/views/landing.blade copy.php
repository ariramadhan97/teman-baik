...
<html lang="en">
    ...
    <body>
        <div class="vw-100 min-vh-100 d-flex flex-column position-relative">
            <div class="container-fluid">
                <nav class="navbar bg-white">
                    <a href="/login" class="btn px-4 rounded-pill btn-outline-primary ms-auto py-1">login</a>
                </nav>
            </div>
            <div class="container mt-5 flex-grow-1 d-flex">
                <div class="row pt-md-5 align-items-center">
                    ...
                    <div class="col-lg-6 d-flex align-items-center justify-content-center order-first order-lg-last mb-5">
            ...
            <div class="w-100">
                ...
                <div class="bg-primary d-block d-md-none" style="height: 100px; margin-top:-2px">&nbsp;</div>
            </div>
